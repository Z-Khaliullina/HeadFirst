package ru.otus.javaFirst.guessGame;
...
public class GuessGame {
    ...
    public void startGame(){
        ...
        while (true){
            ...
            //!!!!!!Зачем создавать guessp1, guessp2,guessp3, если можно просто исользовать p1.number??
...
//            }
            ...
            if(p1isRight||p2isRight||p3isRight){
                System.out.println("У нас есть победитель! Посмотрим, кто угадал:");
